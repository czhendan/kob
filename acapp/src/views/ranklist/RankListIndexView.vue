                ...
                <div>
                    ...
                    <nav aria-label="...">
                        <ul style="padding: 0;">
                            ...
                            <li @click="click_page(page.number)" :class="'game-page-item ' + page.is_active" v-for="page in pages" :key="page.number">
...
export default {
    ...
    setup() {
        ...
        const pull_page = page => {
            current_page = page;
            $.ajax({
                url: "https://app7358.acapp.acwing.com.cn/api/ranklist/getlist/",
                type: "get",
                data: {
                    page,
                },
